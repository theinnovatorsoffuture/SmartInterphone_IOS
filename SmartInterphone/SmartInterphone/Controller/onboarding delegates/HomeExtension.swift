...
extension HomeVC :  CoachMarksControllerDataSource {
    ...
    func coachMarksController(_ coachMarksController: CoachMarksController,
        ...
        switch(index) {
        case 0:
            return coachMarksController.helper.makeCoachMark(for: userImg,
                                                             cutoutPathMaker: cutoutPathMaker)
        case 1:
            return coachMarksController.helper.makeCoachMark(for: logoutBtn,
                                                             cutoutPathMaker: cutoutPathMaker)
        default:
...
extension HomeVC: CoachMarksControllerAnimationDelegate {
    func coachMarksController(_ coachMarksController: CoachMarksController,
